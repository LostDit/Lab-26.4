## [Задание 1. Реализация имитации аудиоплеера](https://github.com/LostDit/Lab-26.4/blob/main/imitationAudioplayer.cpp)
### Что нужно сделать
...
## [Задание 2. Реализация программы симуляции мобильного телефона](https://github.com/LostDit/Lab-26.4/blob/main/imitationPhone.cpp)
### Что нужно сделать
...
## [Задание 3. Реализация программы управления окном рабочего стола](https://github.com/LostDit/Lab-26.4/blob/main/imitationWindow.cpp)
### Что нужно сделать
